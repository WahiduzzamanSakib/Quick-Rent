        ...
        const fetchProperties = async () => {
            try {
                const res = await fetch(
                    `http://localhost:5000/dashboard/recent-properties`
                );
                    ...
                    >
                        ...
                        <div className="p-5 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
                                ...
                                <div className="flex items-center gap-2 font-bold text-md  text-black">
                                    <FaMoneyBillWaveAlt className="text-gray-400" />
                                    {item.rent}
                                </div>
                            </div>
